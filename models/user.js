...
const { promisify } = require('util');//The util module is primarily designed to support the needs of Node.js' own internal APIs.
...
const tokenExpiry = process.env.TOKEN_EXPIRY || '10hr';
...
//In registration : hashing , beforeSave , transform
